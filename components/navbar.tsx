                                ...
                                <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-2 min-w-150">
                                    ...
                                    <div className="p-2 border-t border-gray-200/80">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            ...
                                            >
                                                <icons.Settings className="w-4 h-4 text-gray-600 group-hover:text-white transition-colors duration-300" />
                                                <span className="text-sm font-medium text-gray-600 group-hover:text-white transition-colors duration-300">ตั้งค่า</span>
                                            </button>
                                            <button
                                            ...
                                            >
                                                <icons.LogOut className="w-4 h-4 text-rose-500 group-hover:text-white transition-colors duration-300" />
                                                <span className="text-sm font-medium text-rose-500 group-hover:text-white transition-colors duration-300">ออกจากระบบ</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
export const NavHome = () => <Navbar isHome={true} />;
export const NavElse = ({ title }: { title: string }) => <Navbar isHome={false} title={title} />;